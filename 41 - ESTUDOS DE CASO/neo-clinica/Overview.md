...
type: projeto
status: produção
stack: [Django 6, PostgreSQL, HTMX]
priority: crítico
created: 2026-09-03
updated: 2026-09-03
---
...
**Stack**: Django 6 + PostgreSQL + HTMX + ES2022+  
...
Reescrita completa do neo-desenvolver em Django com:
- ✅ **13 páginas operacionais**
- ✅ **100+ endpoints** bem estruturados
- ✅ **Fases 1-5 completas**
...
Cada uma é um teste obrigatório:
...
7. Transações em repasse
8. Soft-delete em histórico
9. Autorização em endpoints
...
- [[07 - BACKEND/Django - Models & ORM]] — Framework usado
